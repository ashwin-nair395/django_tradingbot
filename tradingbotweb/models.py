...
class CurrencyHistory(models.Model):
    ...
    def get_value(self):
        ...
        if self.symbol.symbol != 'USD':  # Avoid 'USDUSD' case
            usd_ask_value = json_data[f'{self.symbol.symbol}USD']['ask']
        else:
            usd_ask_value = 1  # Assuming 1 USD = 1 USD
...
class ExchangeGoal(models.Model):
    ...
    detination_currency           = models.ForeignKey('Currency', on_delete=models.CASCADE, related_name='exchange_goal')
